				...
				<td valign="top">
					<fieldset>
						...
						<table class="pure-table">
							<thead>
								<tr>
									<th>項目ID</th><th>訂單ID</th><th>商品ID</th>
									<th>數量</th>
								</tr>
							</thead>
							<tbody>
								...
								<c:forEach var="productDTO" items="${ productDTOs }">
									<tr onmouseover="this.style.backgroundColor='#E0E0ff'" 
										...
										<td align="center">${ productDTO.item_id }</td>
										<td>${ productDTO.order_id}</td>
										<td align="right">${ productDTO.product_id }</td>
										<td align="right">${ productDTO.quantity }</td>
										<td>
